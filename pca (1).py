...
print(pca_data)  #check structure of data
...
plt.scatter(x, y, c=[colors[c] for c in clusters], s=7)
...
plt.scatter(x1[df["species"] == 0], y1[df["species"] == 0], c="orange", label="setosa", s=7)
plt.scatter(x1[df["species"] == 1], y1[df["species"] == 1], c="blue", label="versicolor", s=7)
plt.scatter(x1[df["species"] == 2], y1[df["species"] == 2], c="green", label="virginica", s=7)
...
y2 = df["sepal width (cm)"]

plt.scatter(x2[df["species"] == 0], y2[df["species"] == 0], c="orange", label="setosa", s=7)
plt.scatter(x2[df["species"] == 1], y2[df["species"] == 1], c="blue", label="versicolor", s=7)
plt.scatter(x2[df["species"] == 2], y2[df["species"] == 2], c="green", label="virginica", s=7)
